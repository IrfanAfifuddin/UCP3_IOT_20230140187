...
new (0, _autoDefault.default)(document.getElementById('tempChart'), {
    type: 'line',
    data: {
        labels: labels,
        datasets: [
...
new (0, _autoDefault.default)(document.getElementById('humChart'), {
    type: 'line',
    data: {
        labels: labels,
        datasets: [
...
new (0, _autoDefault.default)(document.getElementById('pressChart'), {
    type: 'line',
    data: {
        labels: labels,
        datasets: [
...
//# sourceMappingURL=UCP3.ee3750bf.js.map
